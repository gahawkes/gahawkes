...
goog_regular_trainingset=array(0,c(301,1));
...
goog_regular_trainingset[301,1]=goog_trainingset[n,2];
goog_ts_reg_traingset=ts(goog_regular_trainingset,start=1,end=301)
